...
### Réponse :
Les vésicules séminales (2 glandes) sécrètent le liquide séminal, qui sert à assurer la survie des spermatozoïdes.

---

## 7. Qu'est-ce que le sperme ?

### Réponse :
Le sperme est l'ensemble formé par les spermatozoïdes dilués dans le liquide séminal (des vésicules séminales) et le liquide prostatique (de la prostate). Ces liquides permettent la survie et le déplacement des spermatozoïdes.

---

## 8. Citer les caractéristiques du spermatozoïde.
...
## 10. De quoi est composé l'appareil génital féminin ?
...
## 11. Quel est le rôle des ovaires ?
...
## 12. Quel est le rôle des trompes de Fallope ?
...
## 14. Quel est le rôle de l'utérus ?

### Réponse :
L'utérus est l'organe de la gestation où se développe le fœtus. Il accueille l'œuf fécondé lors de la nidation et assure le développement de l'embryon puis du fœtus pendant toute la grossesse.
...
**Spermiogenèse :**
5. Spermatide → Spermatozoïde (haploïde, n = 23) → phase de différenciation
...
7. Ménopause : environ 400 ovocytes II ovulés au total sur toute une vie
...
| Résultat | 4 spermatozoïdes viables | 1 ovocyte + globules polaires (non viables) |
| Gamètes produits | Des milliards | Environ 400 sur toute la vie |
