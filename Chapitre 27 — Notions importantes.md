...
**Étymologies utiles :**
- **Physi(o)** = fonctionnement / **-logie** = étude de → **Physiologie** = étude du fonctionnement
...
- **Ovari(o)** = ovaire / **Ov(o)** = œuf
- **Salping(o)** = trompe
- **Méno(s)** = mois → **Ménopause** = arrêt définitif des règles ou menstruations
...
### Glandes annexes
- **Vésicules séminales** (2 glandes) : sécrètent le **liquide séminal** → assure la **survie des spermatozoïdes**.
- **Prostate** : sécrète un **liquide prostatique alcalin** (alcalin = basique = pH supérieur à 7) → protège et facilite le déplacement des spermatozoïdes.
- **Glandes bulbo-urétrales** (= glandes de Cowper) : sécrètent un **lubrifiant** dans l'urètre → facilite le transport des spermatozoïdes lors de l'éjaculation.
...
- **Utérus** : organe creux musculeux de la taille d'une petite poire renversée. Formé de 2 parties : le corps et le **col de l'utérus** qui débouche dans le vagin. D'un point de vue histologique, formé de l'intérieur vers l'extérieur :
  - **Endomètre** (couche interne) : évolue perpétuellement au cours du cycle sexuel. S'il n'y a pas de grossesse → éliminé en fin de cycle = **règles / menstruations**.
  - **Myomètre** (couche externe) : épaisse enveloppe de muscles lisses qui se contracte volontairement, **au moment de l'accouchement et au début de chaque cycle** pour expulser l'endomètre.
...
- **Méiose I** (division réductionnelle) :
  - **Prophase I** : **brassage intrachromosomique** (échanges de fragments entre chromatides = crossing-over)
  - **Anaphase I** : **brassage interchromosomique** (séparation aléatoire des chromosomes homologues)
...
### Histologie du testicule (à connaître ⚠️)

| Structure | Rôle |
|---|---|
| **Tube séminifère** | Lieu de la spermatogenèse |
| **Lumière du tube** | Contient les spermatozoïdes |
| **Cellules de Leydig** | Cellules endocrines localisées à l'extérieur des tubes séminifères ; produisent la **testostérone** (indispensable à la spermatogenèse) |
...
| **Cellules germinales** | Cellules qui aboutissent à la production des spermatozoïdes (tous les stades sont représentés) |
...
1. **Spermatogonie** (diploïde, 2n = 46) → multiplication par **mitose**
2. **Spermatocyte I** (diploïde, 2n = 46) → phase d'accroissement
3. **Spermatocyte II** (haploïde, n = 23) → **Méiose I**
4. **Spermatide** (haploïde, n = 23) → **Méiose II**
...
### 7.1 Folliculogenèse (stades du follicule) ⚠️ À connaître
...
| Stade | Description |
|---|---|
| **Follicule primordial** | Ovocyte I + quelques cellules folliculaires nourricières. À la naissance : 1 à 2 millions ; à la puberté : environ 300 000 |
| **Follicule primaire** | À partir de la puberté, au début de chaque cycle menstruel, une vingtaine de follicules primordiaux évoluent en follicules primaires. Les cellules folliculaires forment **une seule couche** de cellules autour de l'ovocyte I |
| **Follicule secondaire** | Multiplication cellulaire → **granulosa** ; zone pellucide visible entre l'ovocyte I et les cellules folliculaires ; **thèques interne et externe** se forment autour du follicule |
...
3. Phase de **maturation** : ovocyte I **bloqué** en 1ère division de méiose (à la naissance : 200 000 à 400 000)
4. **Puberté** → reprise 1ère division de méiose → **Ovocyte II** (haploïde, n = 23) + 1er globule polaire → **OVULATION**
5. Méiose II : ovocyte II **bloqué** en 2ème division
6. **Fécondation** → reprise 2ème division → 2ème globule polaire + **cellule œuf** (diploïde, 2n = 46)
7. **Ménopause** : environ **400 ovocytes II** ovulés au total sur toute la vie
...
- Méiose = 2 divisions → 4 cellules haploïdes
