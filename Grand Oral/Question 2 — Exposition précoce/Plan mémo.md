...
- Internet + réseaux très répandus → accès porno dès le plus jeune âge
- Enjeu santé publique : développement, représentations de la sexualité, bien-être
- Démarche : doc ARCOM + presse + **questionnaire 41 jeunes** + recherche sur Le CAP de Mulhouse
- Garde-fou : questionnaire = perception, pas de valeur statistique
- **Annonce du plan** : I exposition facilitée → II conséquences → III prévention

*« J'ai choisi ce sujet car l'accès à Internet et aux réseaux sociaux est aujourd'hui très répandu… »*
