...
## Questions type contrôle / bac

---

## 1. Définir une politique sociale.
...
## 3. Définir la cohésion sociale et expliquer son lien avec la solidarité.

### Réponse :
La cohésion sociale est la création de **liens sociaux** entre les membres d'une société, qui « tiennent ensemble » grâce à des valeurs et des règles communes acceptées par chacun. Elle favorise l'intégration et la participation des individus à la vie sociale.
...
## 6. Comment a évolué la prise en charge de la pauvreté en France ?
...
## 9. Présenter les quatre caractéristiques des politiques sociales actuelles.

### Réponse :
| Caractéristique | Définition |
|---|---|
| **Responsabilisation du bénéficiaire** | Rendre l'individu acteur de son parcours, sans logique d'assistanat |
| **Transversalité** | Politique interministérielle et partenariale, qui prend en compte l'interdépendance des déterminants et cible un public aux contours flous |
...
## 11. Qu'est-ce que la territorialisation des politiques sociales ? Quelle en est la limite ?

### Réponse :
La territorialisation consiste à mettre en œuvre une politique nationale **au niveau local**, en l'adaptant aux besoins et caractéristiques spécifiques du territoire, via des programmes contractuels entre l'État et les collectivités locales.
...
## 13. Quelle est la différence entre besoin social et problème social ?

### Réponse :
| | Besoin social | Problème social |
|---|---|---|
| Définition | Manque ressenti permettant aux individus de vivre dignement | Besoin social **non satisfait**, qui affecte négativement les individus |
| Conséquences | — | Individuelles (rupture des liens sociaux, besoins fondamentaux non satisfaits) et collectives (impact sur la cohésion sociale) |
...
## 15. Présenter les étapes de l'élaboration d'une politique sociale.

### Réponse :
1. **Diagnostic** des besoins sociaux
...
### Réponse :
La **DGCS** (Direction Générale de la Cohésion Sociale) est une direction d'administration centrale, gérée par le ministère des affaires sociales. Elle **conçoit, pilote et évalue** les politiques publiques de solidarité au niveau national.
...
## 18. Différencier centralisation, déconcentration et décentralisation.

### Réponse :
| Mode | Définition | Exemple |
|---|---|---|
| **Centralisation** | Pouvoirs concentrés au sein de l'État | Administration centrale |
...
## 20. Qu'est-ce que la démocratie sociale ? Quelles en sont les limites ?

### Réponse :
La démocratie sociale consiste à donner aux usagers la possibilité de **participer** à l'élaboration des politiques sociales (avis, expérience) afin de mieux prendre en compte leurs besoins réels.
...
## 22. Différencier mesure, dispositif et politique publique.
...
### Réponse :
- **Pauvreté** : insuffisance de ressources pour satisfaire les besoins essentiels.
